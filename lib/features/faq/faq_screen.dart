...
// FaqScreen: Shows FAQs and contact info. Add more tabs if needed!
class FaqScreen extends StatelessWidget {
  const FaqScreen({super.key});

  @override
  Widget build(BuildContext context) {
    // TODO: Add search bar for FAQs
...
// FaqTab: Shows a list of frequently asked questions
class FaqTab extends StatelessWidget {
  const FaqTab({super.key});

  @override
  Widget build(BuildContext context) {
    // List of FAQ questions. Add more as needed!
    final faqs = [
      "How to use this app?",
...
// ContactUsTab: Shows contact info for support
class ContactUsTab extends StatelessWidget {
  const ContactUsTab({super.key});

  @override
  Widget build(BuildContext context) {
    // TODO: Add email contact and live chat option
    return ResponsivePadding(
      child: Column(
  ...
  // Helper to build contact info rows
