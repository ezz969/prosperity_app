...
// LanguageScreen: Lets user pick app language
...
class _LanguageScreenState extends State<LanguageScreen> {
  ...
  Widget build(BuildContext context) {
    // TODO: Add more languages and persist selection
    return Scaffold(
  ...
  // Build a card for each language option
  ...
  // Show confirmation dialog when changing language
